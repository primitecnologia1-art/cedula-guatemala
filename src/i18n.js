...
const copy = [
  ...
  ['.paper-copy .chapter-label', ['LA IDENTIDAD DE UN PUEBLO EN UN']],
  ['.paper-copy h2', ['IMPRESO DE', 'SEGURIDAD']],
  ['.security-section .section-heading .chapter-label', ['03 — LA PRECISIÓN']],
  ['#security-title', ['Cada detalle', 'tiene una razón.']],
  ['.security-section .section-heading > p', ['Acerca la mirada. Explora el papel, la impresión y los elementos de seguridad que dan forma al billete.']],
